...
// Logo          
            ...
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff;  gap:5px; " align="center">Date </th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px; " align="left">' . $curDate . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px;background-color:#1ddbd5; color:#ffffff; " align="center">First name</th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">' . $row["first_name"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center" >Middle name</th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">' . $row["middle_name"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Last name</th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">' . $row["last_name"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Education </th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">' . $row["education"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Designation </th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">' . $row["designation"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Contact Number </th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">' . $row["contact_number"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Email Id </th>';
            $output .= '<td style="border-top: 0.2px solid black; border-left: 0.2px solid black; height:17px" align="left">' . $row["email_id"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top:  0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Address </th>';
            $output .= '<td style="border-top:  0.2px solid black; border-left:  0.2px solid black; height:17px" align="left">' . $row["address"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top: 0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Date of Joining</th>';
            ...
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top:  0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Birthdate</th>';
            ...
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top:  0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Gender</th>';
            $output .= '<td style="border-top:  0.2px solid black; border-left:  0.2px solid black; height:17px" align="left">' . $row["gender"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top:  0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">martial Status </th>';
            $output .= '<td style="border-top:  0.2px solid black; border-left:  0.2px solid black; height:17px" align="left">' . $row["martial_status"] . '</td>';
            $output .= '</tr>';
            $output .= '<tr>';
            $output .= '<th style="border-top:  0.2px solid black; height:17px; background-color:#1ddbd5; color:#ffffff; " align="center">Salary </th>';
