...
?>
  ...
  <thead>
        ...
        ?>
          <tr>
            ...
            <td class="date_of_joining"><?php echo $row['date_of_joining'] ?></td>
            ...
            <td>
              ...
              <button type="button" class="btn btn-danger delete" data-bs-toggle="modal" data-bs-target="#deletemodal" data-delete-id="<?php echo $row['id'] ?>">
  ...
  bs5
    ...
    <div class="form-group mt-2">
        ...
        <input type="text" class="form-control input_date_of_joining" name="date_of_joining" id="" placeholder="e.g. DD/MM/YYYY">
    </div>
    ...
    <div class="form-group mt-2">
        ...
        <input type="text" class="form-control input_birthdate" name="birthdate" id="update_form" placeholder="e.g. DD/MM/YYYY">
    ...
    $(document).ready(function () {
      $('#dataTable').DataTable({
        ...
        order: [
          [0, 'desc'], // Id column
          [1, 'asc'], // Name column
          [2, 'asc'], // Username column
          [3, 'asc'], // Contact number column
          [4, 'asc']  // Email column
        ]
      });
    });
